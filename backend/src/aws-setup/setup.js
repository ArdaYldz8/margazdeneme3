...
const { LambdaClient, CreateFunctionCommand, UpdateFunctionCodeCommand, GetFunctionCommand, ResourceConflictException, AddPermissionCommand } = require("@aws-sdk/client-lambda");
    ...
    try {
        ...
        try {
            await lambdaClient.send(new AddPermissionCommand({
                FunctionName: FUNCTION_NAME,
                StatementId: "apigateway-invoke-" + Date.now(), // Unique ID
